...
const GITHUB = 'https://github.com/MyBROSKICicada3301';
const LINKEDIN = 'https://www.linkedin.com/in/shishir-s-nambiar/';

/**
 * Author block, sitting in the lower-right corner — where the engraver
 * signed the plate. The wording follows the chart style: a photographic
 * globe is built, a chart is drawn.
 */
export function Credits({ style }: { style: ChartStyle }) {
  return (
    <div className="credits panel">
      <span className="credits-verb">{style === 'mythos' ? 'Drawn by' : 'Built by'}</span>
      <span className="credits-name">Shishir S Nambiar</span>
      <a
        className="credits-link"
        href={GITHUB}
        target="_blank"
        rel="noreferrer noopener"
        title="GitHub — MyBROSKICicada3301"
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer noopener"
        title="LinkedIn — Shishir S Nambiar"
